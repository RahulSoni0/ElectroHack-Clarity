...
public class LofiAdapter extends RecyclerView.Adapter<LofiAdapter.ExploreviewHolder> {

    List<ExploreModel> DataList;
    List<SavedListEntityModel> savedlist = new ArrayList<>();
    Context context;

    public LofiAdapter(List<ExploreModel> dataList, List<SavedListEntityModel> savedlist, Context context) {
        DataList = dataList;
    ...
    public class ExploreviewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imageIv, playIv, likedBtn;
        private TextView titleTv, descTv;

        public ExploreviewHolder(@NonNull View itemView) {
            super(itemView);

            imageIv = itemView.findViewById(R.id.ivHomeItemImage);
            playIv = itemView.findViewById(R.id.btnHomeItemPlay);
            titleTv = itemView.findViewById(R.id.tvHomeItemTitle);
            descTv = itemView.findViewById(R.id.tvHomeItemDescriptionHere);
            likedBtn = itemView.findViewById(R.id.btnHomeItemLiked);
